...
```text
YouTubeSimpleDownloader_Setup_v0.10.1.1-inno-self-signed.exe
```
...
```powershell
Get-FileHash .\YouTubeSimpleDownloader_Setup_v0.10.1.1-inno-self-signed.exe -Algorithm SHA256
```
...
```text
release\YouTubeSimpleDownloader_Setup_v0.10.1.1-inno-self-signed.exe
```
